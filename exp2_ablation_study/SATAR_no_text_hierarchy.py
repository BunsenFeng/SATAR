...
class SemanticVector(nn.Module):
    ...
    def forward(self, user):
        ...
        return torch.cat((WordLevelRep, WordLevelRep))
...
def train():
    ...
    TrainDataLoader = DataLoader(train_set, batch_size=32, num_workers=0, collate_fn=pad_collate,
                                 pin_memory=True, sampler=train_sampler)
    # print('DevDataLoader')
    DevDataLoader = DataLoader(validate_set, batch_size=32, num_workers=0, collate_fn=pad_collate,
                               pin_memory=True, sampler=dev_sampler)
    # print('TestDataLoader')
    TestDataLoader = DataLoader(test_set, batch_size=32, num_workers=0, collate_fn=pad_collate,
